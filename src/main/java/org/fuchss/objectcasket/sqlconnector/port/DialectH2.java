...
public class DialectH2 implements SqlDialect {
	...
	private static Map<StorageClass, String> stClassMap = new EnumMap<>(StorageClass.class);
	static {
	...
	private static Map<CMP, String> cmpMap = new EnumMap<>(CMP.class);
	static {
	...
	private static Map<OP, String> opMap = new EnumMap<>(OP.class);
	static {
		DialectH2.opMap.put(OP.AND, " AND ");
		DialectH2.opMap.put(OP.OR, " OR ");
	}

	private static Map<Flag, String> flagMap = new EnumMap<>(Flag.class);
	static {
