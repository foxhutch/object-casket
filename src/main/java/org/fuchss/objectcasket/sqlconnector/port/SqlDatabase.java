...
public interface SqlDatabase {
	 ...
	 * least tow columns are required). The created table can be accessed via the
	 ...
	 * @param colSigMap
	 *            - the column definitions of the new table.
	 ...
	 * @param colSigMap
	 *            - the column definitions which should be assigned.
	 ...
	 *            - the name of the table.
	 * @param colSigMap
	 *            - the target column definitions which should be assigned.
	 * @return a new TableAssignment to access the table.
	 *
	 * @throws CasketException
	 *             on error.
	 ...
	 *
	 * @param shouldWait
	 *            - if true the method blocks until a new transaction is possible.
	 ...
	 *
	 * @param voucher
	 *            - the voucher of the current transaction.
	 * @throws CasketException
	 *             on error.
	 */
	 ...
	 *
	 * @param tabAssignment
	 *            - the {@link TableAssignment table assignment}.
	 ...
	 *
	 * @param preStat
	 *            - the {@link PreCompiledStatement pre-compiled statement}.
	 * @param values
	 *            - the values for the named columns. The map can only contain
	 ...
	 *            - the {@link TableAssignment table assignment}.
	 * @param columns
	 *            - the names of the columns to alter.
	 * @return the {@link PreCompiledStatement pre-compiled statement}.
	 * @throws CasketException
	 *             on error.
	 ...
	 * @param values
	 *            - the new values. The map can only contain values for columns
	 ...
	 *            - the {@link TableAssignment table assignment}.
	 * @param args
	 *            - the set of arguments defining the selection process.
	 * @param op
	 *            -the binding {@link SqlArg.OP operator}, defining how to combine
	 ...
	 * the set of sqlArgs an the operator used in the pre-compiled statement. If the
	 * voucher in null this is a dirty read. Else it is part of a running
	 * transaction indicated by the given voucher.
	 *
	 * @param preStat
	 *            - the {@link PreCompiledStatement pre-compiled statement} defining
	 *            the selection.
	 * @param relatedObjs
	 ...
	 * the set of sqlArgs an the operator used in the pre-compiled statement. This
	 ...
	 *            - the {@link TableAssignment table assignment}.
	 * @param columnName
	 *            - the effected column name.
	 * @param cmp
	 *            - the {@link SqlArg.CMP comparator}.
	 ...
	 *            - the new observer.
	 * @param tab
	 *            - the observed {@link TableAssignment table assignment}.
	 * @throws CasketException
	 *             on error.
	 */
