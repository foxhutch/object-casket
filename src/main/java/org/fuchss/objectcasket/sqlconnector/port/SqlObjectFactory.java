...
public interface SqlObjectFactory {
	 ...
	 *                     cell.
	 * @param type         - the {@link StorageClass SQL type} of the column.
	 * @param javaType     - the Java type which should be stored in this column.
	 * @param defaultValue - the default value, which should be used if and new row will be
	 *                     created.
	 * @return a {@link SqlColumnSignature signature object} which can be
	 * individualized further.
	 * @throws CasketException on error. Maybe SQL type and Java type are incompatible. See
	 ...
	 * @param type - the corresponding SQL type.
	 ...
	 *
	 * @param sqlObj - the {@link SqlObject}
