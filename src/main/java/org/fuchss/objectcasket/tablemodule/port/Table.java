...
public interface Table {
	 ...
	 *
	 * @param values
	 *            - column names and their initial values. A mapping for the primary
	 *            key is required if the key is not generated automatically.
	 * @param voucher
	 *            - an object representing the running transaction.
	 * @return the new row.
	 * @throws CasketException
	 *             on error. If an exception occurs inside an open transaction a
	 ...
	 *
	 * @param args
	 *            - the set of {@link Exp expressions}.
	 * @param voucher
	 *            - an object representing the running transaction.
	 ...
	 * @param op
	 *            - the {@link TabCMP comparator}: {@link TabCMP#LESS},
	 *            {@link TabCMP#GREATER}, {@link TabCMP#EQUAL},
	 *            {@link TabCMP#LESSEQ}, {@link TabCMP#GREATEREQ},
	 *            {@link TabCMP#UNEQUAL};
	 *
	 */
	final record Exp(String columnName, TabCMP op, Serializable value) {
	}
