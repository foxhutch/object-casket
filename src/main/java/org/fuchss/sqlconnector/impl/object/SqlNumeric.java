...
public class SqlNumeric extends SqlObjectImpl {
	...
	static {
		SqlNumeric.CAST.put(Long.class, n -> n == null ? null : ((Number) n).longValue());
		SqlNumeric.CAST.put(Integer.class, n -> n == null ? null : ((Number) n).intValue());
		SqlNumeric.CAST.put(Short.class, n -> n == null ? null : ((Number) n).shortValue());
		SqlNumeric.CAST.put(Byte.class, n -> n == null ? null : ((Number) n).byteValue());

		SqlNumeric.CAST.put(Double.class, n -> n == null ? null : ((Number) n).doubleValue());
		SqlNumeric.CAST.put(Float.class, n -> n == null ? null : ((Number) n).floatValue());

		SqlNumeric.CAST.put(Long.TYPE, n -> n == null ? ((long) 0) : ((Number) n).longValue());
		SqlNumeric.CAST.put(Integer.TYPE, n -> n == null ? ((int) 0) : ((Number) n).intValue());
		SqlNumeric.CAST.put(Short.TYPE, n -> n == null ? ((short) 0) : ((Number) n).shortValue());
		SqlNumeric.CAST.put(Byte.TYPE, n -> n == null ? ((byte) 0) : ((Number) n).byteValue());

		SqlNumeric.CAST.put(Double.TYPE, n -> n == null ? ((double) 0.0) : ((Number) n).doubleValue());
		SqlNumeric.CAST.put(Float.TYPE, n -> n == null ? ((float) 0.0) : ((Number) n).floatValue());
	}
	...
	public <T> T get(Class<T> type, Field target) {
		Function<Object, Object> cast = SqlNumeric.CAST.get(type);
		if (cast == null) {
			return null;
		}
		if (this.isDouble) {
