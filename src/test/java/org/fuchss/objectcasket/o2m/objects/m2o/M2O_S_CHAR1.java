...
@Entity()
@Table(name = "M2O_S_CHAR1")
public final class M2O_S_CHAR1 implements M2O__S_Object<M2O_S_CHAR1> {
	...
	public M2O_S_CHAR1(char x) {
		this.pk = x;
	}

	@Override
	public boolean sameAs(M2O_S_CHAR1 x, M2O_S_CHAR1 y) {
		return (x == y) || ((x != null) && (y != null) && (x.pk.charValue() == y.pk.charValue()));
	}
