...
@Entity()
@Table(name = "M2O_S_DOUBLE1")
public final class M2O_S_DOUBLE1 implements M2O__S_Object<M2O_S_DOUBLE1> {
	@Id
	Double pk;
	...
	public M2O_S_DOUBLE1(double x) {
		this.pk = x;
	}

	@Override
	public boolean sameAs(M2O_S_DOUBLE1 x, M2O_S_DOUBLE1 y) {
