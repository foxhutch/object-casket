...
@Entity()
@Table(name = "M2O_S_NUMERIC1")
public final class M2O_S_NUMERIC1 implements M2O__S_Object<M2O_S_NUMERIC1> {
	...
	public M2O_S_NUMERIC1(long x) {
		this.pk = x;
	}

	@Override
	public boolean sameAs(M2O_S_NUMERIC1 x, M2O_S_NUMERIC1 y) {
