...
@Entity()
@Table(name = "M2O_C_BOOL2")
public final class M2O_C_BOOL2 implements M2O__C_Object<M2O_C_BOOL2> {
	...
	@Override
	public boolean sameAs(M2O_C_BOOL2 x, M2O_C_BOOL2 y) {
		if (x == y)
			return true;
		if (!((x != null) && (y != null) && (x.pk == y.pk)))
			return false;
