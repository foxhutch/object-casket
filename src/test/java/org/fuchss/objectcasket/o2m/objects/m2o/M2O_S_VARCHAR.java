...
@Entity()
@Table(name = "M2O_S_VARCHAR")
public final class M2O_S_VARCHAR implements M2O__S_Object<M2O_S_VARCHAR> {
	@Id
	String pk;
	...
	public M2O_S_VARCHAR(String x) {
		this.pk = x;
	}

	@Override
	public boolean sameAs(M2O_S_VARCHAR x, M2O_S_VARCHAR y) {
