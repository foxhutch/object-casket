...
@Entity()
@Table(name = "M2O_S_NUMERIC11")
public final class M2O_S_NUMERIC11 implements M2O__S_Object<M2O_S_NUMERIC11> {
	...
	public M2O_S_NUMERIC11(float x) {
		this.pk = x;
	}

	@Override
	public boolean sameAs(M2O_S_NUMERIC11 x, M2O_S_NUMERIC11 y) {
		return (x == y) || ((x != null) && (y != null) && (x.pk.floatValue() == y.pk.floatValue()));
	}
