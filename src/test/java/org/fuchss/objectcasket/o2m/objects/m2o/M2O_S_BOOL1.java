...
@Entity()
@Table(name = "M2O_S_BOOL1")
public final class M2O_S_BOOL1 implements M2O__S_Object<M2O_S_BOOL1> {
	...
	public M2O_S_BOOL1(boolean x) {
		this.pk = x;
	}

	@Override
	public boolean sameAs(M2O_S_BOOL1 x, M2O_S_BOOL1 y) {
		return (x == y) || ((x != null) && (y != null) && (x.pk.booleanValue() == y.pk.booleanValue()));
	}
