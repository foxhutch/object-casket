...
@Entity()
@Table(name = "M2O_C_BOOL1")
public final class M2O_C_BOOL1 implements M2O__C_Object<M2O_C_BOOL1> {
	...
	@Override
	public boolean sameAs(M2O_C_BOOL1 x, M2O_C_BOOL1 y) {
		if (x == y)
			return true;
