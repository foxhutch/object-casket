...
@Entity()
@Table(name = "M2O_S_INTEGER6")
public final class M2O_S_INTEGER6 implements M2O__S_Object<M2O_S_INTEGER6> {
	...
	public M2O_S_INTEGER6(int x) {
		this.pk = x;
	}

	@Override
	public boolean sameAs(M2O_S_INTEGER6 x, M2O_S_INTEGER6 y) {
		return x.pk == y.pk;
	}
