...
@Entity()
@Table(name = "M2O_S_NUMERIC3")
public final class M2O_S_NUMERIC3 implements M2O__S_Object<M2O_S_NUMERIC3> {
	...
	public M2O_S_NUMERIC3(short x) {
		this.pk = x;
	}

	@Override
	public boolean sameAs(M2O_S_NUMERIC3 x, M2O_S_NUMERIC3 y) {
