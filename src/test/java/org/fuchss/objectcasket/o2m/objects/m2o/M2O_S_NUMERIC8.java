...
@Entity()
@Table(name = "M2O_S_NUMERIC8")
public final class M2O_S_NUMERIC8 implements M2O__S_Object<M2O_S_NUMERIC8> {
	...
	public M2O_S_NUMERIC8(byte x) {
		this.pk = x;
	}

	@Override
	public boolean sameAs(M2O_S_NUMERIC8 x, M2O_S_NUMERIC8 y) {
		return x.pk == y.pk;
	}
