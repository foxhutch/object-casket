...
@Entity()
@Table(name = "M2O_S_NUMERIC5")
public final class M2O_S_NUMERIC5 implements M2O__S_Object<M2O_S_NUMERIC5> {
	...
	public M2O_S_NUMERIC5(long x) {
		this.pk = x;
	}

	@Override
	public boolean sameAs(M2O_S_NUMERIC5 x, M2O_S_NUMERIC5 y) {
		return x.pk == y.pk;
	}
