...
@Entity()
@Table(name = "M2O_S_DATE")
public final class M2O_S_DATE implements M2O__S_Object<M2O_S_DATE> {
	...
	public M2O_S_DATE(Date x) {
		this.pk = x;
	}

	@Override
	public boolean sameAs(M2O_S_DATE x, M2O_S_DATE y) {
