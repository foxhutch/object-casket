...
@Entity()
@Table(name = "M2O_S_INTEGER3")
public final class M2O_S_INTEGER3 implements M2O__S_Object<M2O_S_INTEGER3> {
	...
	@Override
	public boolean sameAs(M2O_S_INTEGER3 x, M2O_S_INTEGER3 y) {
