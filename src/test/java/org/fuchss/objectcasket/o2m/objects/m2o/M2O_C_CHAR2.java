...
@Entity()
@Table(name = "M2O_C_CHAR2")
public final class M2O_C_CHAR2 implements M2O__C_Object<M2O_C_CHAR2> {
	...
	@Override
	public boolean sameAs(M2O_C_CHAR2 x, M2O_C_CHAR2 y) {
		if (x == y)
			return true;
