...
@Entity()
@Table(name = "M2O_S_FLOAT1")
public final class M2O_S_FLOAT1 implements M2O__S_Object<M2O_S_FLOAT1> {
	@Id
	Float pk;
	...
	public M2O_S_FLOAT1(float x) {
		this.pk = x;
	}

	@Override
	public boolean sameAs(M2O_S_FLOAT1 x, M2O_S_FLOAT1 y) {
