...
@Entity()
@Table(name = "M2O_S_NUMERIC12")
public final class M2O_S_NUMERIC12 implements M2O__S_Object<M2O_S_NUMERIC12> {
	...
	public M2O_S_NUMERIC12(float x) {
		this.pk = x;
	}

	@Override
	public boolean sameAs(M2O_S_NUMERIC12 x, M2O_S_NUMERIC12 y) {
		return x.pk == y.pk;
	}
