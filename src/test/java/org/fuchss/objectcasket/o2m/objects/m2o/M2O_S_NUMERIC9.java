...
@Entity()
@Table(name = "M2O_S_NUMERIC9")
public final class M2O_S_NUMERIC9 implements M2O__S_Object<M2O_S_NUMERIC9> {
	...
	public M2O_S_NUMERIC9(double x) {
		this.pk = x;
	}

	@Override
	public boolean sameAs(M2O_S_NUMERIC9 x, M2O_S_NUMERIC9 y) {
		return (x == y) || ((x != null) && (y != null) && (x.pk.doubleValue() == y.pk.doubleValue()));
	}
