...
@Entity()
@Table(name = "M2O_S_NUMERIC4")
public final class M2O_S_NUMERIC4 implements M2O__S_Object<M2O_S_NUMERIC4> {
	...
	public M2O_S_NUMERIC4(byte x) {
		this.pk = x;
	}

	@Override
	public boolean sameAs(M2O_S_NUMERIC4 x, M2O_S_NUMERIC4 y) {
