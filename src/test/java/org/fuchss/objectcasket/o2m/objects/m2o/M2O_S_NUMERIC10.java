...
@Entity()
@Table(name = "M2O_S_NUMERIC10")
public final class M2O_S_NUMERIC10 implements M2O__S_Object<M2O_S_NUMERIC10> {
	...
	public M2O_S_NUMERIC10(double x) {
		this.pk = x;
	}

	@Override
	public boolean sameAs(M2O_S_NUMERIC10 x, M2O_S_NUMERIC10 y) {
		return x.pk == y.pk;
	}
