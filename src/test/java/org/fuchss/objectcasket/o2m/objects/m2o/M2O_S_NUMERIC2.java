...
@Entity()
@Table(name = "M2O_S_NUMERIC2")
public final class M2O_S_NUMERIC2 implements M2O__S_Object<M2O_S_NUMERIC2> {
	...
	public M2O_S_NUMERIC2(int x) {
		this.pk = x;
	}

	@Override
	public boolean sameAs(M2O_S_NUMERIC2 x, M2O_S_NUMERIC2 y) {
