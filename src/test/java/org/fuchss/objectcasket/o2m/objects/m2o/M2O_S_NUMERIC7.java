...
@Entity()
@Table(name = "M2O_S_NUMERIC7")
public final class M2O_S_NUMERIC7 implements M2O__S_Object<M2O_S_NUMERIC7> {
	...
	public M2O_S_NUMERIC7(short x) {
		this.pk = x;
	}

	@Override
	public boolean sameAs(M2O_S_NUMERIC7 x, M2O_S_NUMERIC7 y) {
		return x.pk == y.pk;
	}
