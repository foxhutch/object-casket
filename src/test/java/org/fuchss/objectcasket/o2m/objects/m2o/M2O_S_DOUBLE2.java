...
@Entity()
@Table(name = "M2O_S_DOUBLE2")
public final class M2O_S_DOUBLE2 implements M2O__S_Object<M2O_S_DOUBLE2> {
	...
	public M2O_S_DOUBLE2(double x) {
		this.pk = x;
	}

	@Override
	public boolean sameAs(M2O_S_DOUBLE2 x, M2O_S_DOUBLE2 y) {
		return x.pk == y.pk;
	}
