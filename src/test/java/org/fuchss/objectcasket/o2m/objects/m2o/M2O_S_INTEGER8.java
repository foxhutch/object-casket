...
@Entity()
@Table(name = "M2O_S_INTEGER8")
public final class M2O_S_INTEGER8 implements M2O__S_Object<M2O_S_INTEGER8> {
	...
	public M2O_S_INTEGER8(byte x) {
		this.pk = x;
	}

	@Override
	public boolean sameAs(M2O_S_INTEGER8 x, M2O_S_INTEGER8 y) {
		return x.pk == y.pk;
	}
