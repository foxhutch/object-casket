...
@Entity()
@Table(name = "M2O_S_INTEGER4")
public final class M2O_S_INTEGER4 implements M2O__S_Object<M2O_S_INTEGER4> {
	...
	@Override
	public boolean sameAs(M2O_S_INTEGER4 x, M2O_S_INTEGER4 y) {
