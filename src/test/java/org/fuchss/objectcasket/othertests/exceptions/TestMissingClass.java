...
public class TestMissingClass extends TestBase {
	...
	public void test1() throws Exception {
		...
		Assert.assertTrue(actualMessage.contains("class A"));
	...
	public void test2() throws Exception {
		...
		String actualMessage = exception.getMessage();
		Assert.assertTrue(actualMessage.contains("class B"));
	...
	public void test3() throws Exception {
		...
		String actualMessage = exception.getMessage();
		Assert.assertTrue(actualMessage.contains("class C"));
	...
	public void test4() throws Exception {
		...
		String actualMessage = exception.getMessage();
		Assert.assertTrue(actualMessage.contains("class D"));
	...
	public void test5() throws Exception {
		...
		String actualMessage = exception.getMessage();
		Assert.assertTrue(actualMessage.contains("table E"));
